 ...
 *
 * @author Frank M. Carrano, Timothy Henry, Steve Holtz
 *
 * @date 5 Apr 2016
 * @version 7.0 */
...
class QueueInterface {
 public:
   ...
   *
   * @post If successful, newEntry is stored at the back of this queue.
   *
   ...
   *
   * @post If successful, the front of this queue has been removed.
   *
